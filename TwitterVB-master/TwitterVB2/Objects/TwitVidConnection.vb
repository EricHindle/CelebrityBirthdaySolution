...
#End Region
        ...
        Private Sub Authenticate()
            Try
                ...
                tvAuthRequest = CType(WebRequest.Create(TWITVID_AUTH_URL), HttpWebRequest)
        ...
        Public Function Upload(ByVal p_strFileName As String, ByVal p_strMessage As String) As String
            ...
            Dim rqUpload As HttpWebRequest = DirectCast(WebRequest.Create(TWITVID_UPLOAD_URL), HttpWebRequest)
            With rqUpload
