...
#Region "Twitter API Method Constants"
        ...
        Const ACCOUNT_VERIFY_CREDENTIALS As String = "http://api.twitter.com/1.1/account/verify_credentials.xml"
        Const ACCOUNT_UPDATE As String = "http://api.twitter.com/1.1/account/update_profile.xml"
        Const BLOCKS_BLOCKING As String = "http://api.twitter.com/1.1/blocks/blocking.xml"
        Const BLOCKS_BLOCKING_IDS As String = "http://api.twitter.com/1.1/blocks/blocking/ids.xml"
        Const BLOCKS_CREATE As String = "http://api.twitter.com/1.1/blocks/create/{0}.xml"
        Const BLOCKS_DESTROY As String = "http://api.twitter.com/1.1/blocks/destroy/{0}.xml"
        Const DIRECT_MESSAGES As String = "http://api.twitter.com/1.1/direct_messages.xml"
        Const DIRECT_MESSAGES_DESTROY As String = "http://api.twitter.com/1.1/direct_messages/destroy/{0}.xml"
        Const DIRECT_MESSAGES_NEW As String = "http://api.twitter.com/1.1/direct_messages/new.xml"
        Const DIRECT_MESSAGES_SENT As String = "http://api.twitter.com/1.1/direct_messages/sent.xml"
        Const FAVORITES_CREATE As String = "http://api.twitter.com/1.1/favorites/create/{0}.xml"
        Const FAVORITES_DESTROY As String = "http://api.twitter.com/1.1/favorites/destroy/{0}.xml"
        Const FAVORITES_LIST As String = "http://api.twitter.com/1.1/favorites.xml"
        Const FOLLOWERS_URL As String = "http://api.twitter.com/1.1/followers/ids.xml"
        Const FRIENDS_URL As String = "http://api.twitter.com/1.1/friends/ids.xml"
        Const FRIENDSHIP_CREATE As String = "http://api.twitter.com/1.1/friendships/create/{0}.xml"
        Const FRIENDSHIP_SHOW As String = "http://api.twitter.com/1.1/friendships/show.xml?{0}={1}&{2}={3}"
        Const FRIENDSHIP_DESTROY As String = "http://api.twitter.com/1.1/friendships/destroy/{0}.xml"
        Const LISTS As String = "http://api.twitter.com/1.1/{0}/lists.xml"
        Const LISTS_MEMBERS As String = "http://api.twitter.com/1.1/{0}/{1}/members.xml"
        Const LISTS_MEMBERS_ID As String = "http://api.twitter.com/1.1/{0}/{1}/members/{2}.xml"
        Const LISTS_MEMBERSHIPS As String = "http://api.twitter.com/1.1/{0}/lists/memberships.xml"
        Const LISTS_SPECIFY As String = "http://api.twitter.com/1.1/{0}/lists/{1}.xml"
        Const LISTS_STATUSES As String = "http://api.twitter.com/1.1/{0}/lists/{1}/statuses.xml"
        Const LISTS_SUBSCRIBERS As String = "http://api.twitter.com/1.1/{0}/{1}/subscribers.xml"
        Const LISTS_SUBSCRIBERS_ID As String = "http://api.twitter.com/1.1/{0}/{1}/subscribers/{2}.xml"
        Const LISTS_SUBSCRIPTIONS As String = "http://api.twitter.com/1.1/{0}/lists/subscriptions.xml"
        Const REPORT_SPAM As String = "http://api.twitter.com/1.1/report_spam.xml"
        Const SEARCH_URL As String = "http://search.twitter.com/search.atom"
        Const STATUSES_DESTROY As String = "http://api.twitter.com/1.1/statuses/destroy/{0}.xml"
        Const STATUSES_FRIENDS As String = "http://api.twitter.com/1.1/statuses/friends.xml"
        Const STATUSES_FOLLOWERS As String = "http://api.twitter.com/1.1/statuses/followers.xml"
        Const STATUSES_FRIENDS_TIMELINE As String = "http://api.twitter.com/1.1/statuses/friends_timeline.xml"
        Const STATUSES_HOME_TIMELINE As String = "http://api.twitter.com/1.1/statuses/home_timeline.xml"
        Const STATUSES_MENTIONS As String = "http://api.twitter.com/1.1/statuses/mentions.xml"
        Const STATUSES_PUBLIC_TIMELINE As String = "http://api.twitter.com/1.1/statuses/public_timeline.xml"
        Const STATUSES_REPLIES As String = "http://api.twitter.com/1.1/statuses/replies.xml"
        Const STATUSES_RETWEET As String = "http://api.twitter.com/1.1/statuses/retweet/{0}.xml"
        Const STATUSES_RETWEETED_BY_ME As String = "http://api.twitter.com/1.1/statuses/retweeted_by_me.xml"
        Const STATUSES_RETWEETED_TO_ME As String = "http://twitter.com/statuses/retweeted_to_me.xml"
        Const STATUSES_RETWEETS As String = "http://api.twitter.com/1.1/statuses/retweets/id.xml"
        Const STATUSES_RETWEETS_OF_ME As String = "http://api.twitter.com/1.1/statuses/retweets_of_me.xml"
        Const STATUSES_SHOW As String = "http://api.twitter.com/1.1/statuses/show/{0}.xml"
        Const STATUSES_UPDATE As String = "http://api.twitter.com/1.1/statuses/update.xml"
        Const STATUSES_USER_TIMELINE As String = "http://api.twitter.com/1.1/statuses/user_timeline.xml"
        ...
        Const TREND_LOCATIONS As String = "http://api.twitter.com/1.1/trends/available.xml"
        Const TREND_LOCATION_TRENDS As String = "http://api.twitter.com/1.1/trends/{0}.json"
        Const USERS_SEARCH As String = "http://api.twitter.com/1.1/users/search.xml"
        Const USERS_SHOW As String = "http://api.twitter.com/1.1/users/show.xml"
        Const UPDATE_PROFILE_IMAGE As String = "http://api.twitter.com/1.1/account/update_profile_image.xml"
#End Region
...
#Region "User Methods"
        ...
        ''' When you call this method, you should let your users know that there may be a delay or use it in a separate thread.
        ''' </remarks>
        Public Sub Followers(ByVal Parameters As TwitterParameters, Results As PagedResults(Of TwitterUser))
...
#Region "OAuth Methods"
    ...
    Public Function GetAuthorizationLink_CB(ByVal ConsumerKey As String, ByVal ConsumerKeySecret As String) As String
        Me.Twitter_OAuth = New TwitterOAuth(ConsumerKey, ConsumerKeySecret)
        Return Me.Twitter_OAuth.GetAuthorizationLink_CB()
    End Function
