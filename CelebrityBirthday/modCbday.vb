...
Module modCbday
    ...
    Public Function RemoveSquareBrackets(ByVal _text As String) As String
        ...
        Return newText
    End Function
    Public Function ParseStringWithBrackets(ByRef _string As String, Optional ByRef _start As Integer = 0, Optional ByVal _openChar As Char = "("c) As List(Of String)
